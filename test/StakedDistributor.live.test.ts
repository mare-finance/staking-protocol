...
async function deployTokensFixture() {
    ...
    await (await mare.connect(admin).transfer(staker0.address, initialBalance0)).wait(1);
    await (await mare.connect(admin).transfer(staker1.address, initialBalance1)).wait(1);
